...
var bio = {
    ...
    "contacts": {
        ...
        "github": "github.com/TheTravisM",
        "linkedin": "linkedin.com/in/travismikolay",
        "twitter": "#",
        "location": "Rogers, AR"
    },
    "welcomeMessage": "It's time to start living the life you've only imagined.",
    "skills": [
        "HTML 5",
        "CSS 3",
        "JavaScript",
...
var work = {
    "jobs": [{
        ...
        },
        {
            ...
            "dates": "2009-2010",
            "description": "• Created and updated existing website<br>• Focused on photo editing and manipulation<br>• Specialize in Adobe Flash web design"
        }
    ]
};
...
var education = {
    "schools": [{
        ...
        {
            "name": "Glen Este Highschool",
            "location": "Cincinnati, OH",
            "degree": "",
            "dates": "2000-2004",
            "url": "http://www.westcler.k12.oh.us/",
            "majors": [],
            "minors": []
        }
    ],
...
projects.display = function() {
    projects.projects.forEach(function(project) {
        ...
        $("h3.project-title:last").append(formattedDates);
        ...
        $(".project-description:last").append(formattedGitHub);
    });
};
projects.display();
...
// - - [ Contact Info
var formattedHTMLmobile = HTMLmobile.replace("%data%", bio.contacts.mobile);
$("#lets-connect").append(formattedHTMLmobile);
$("#lets-connect li.mobile a:last").append(bio.contacts.mobile);
var formattedHTMLemail = HTMLemail.replace("%data%", bio.contacts.email);
$("#lets-connect").append(formattedHTMLemail);
$("#lets-connect li.email a:last").append(bio.contacts.email);
var formattedHTMLlinkedin = HTMLlinkedin.replace("%data%", bio.contacts.linkedin);
$("#lets-connect").append(formattedHTMLlinkedin);
$("#lets-connect li.linkedin a:last").append(bio.contacts.linkedin);
var formattedHTMLgithub = HTMLgithub.replace("%data%", bio.contacts.github);
$("#lets-connect").append(formattedHTMLgithub);
